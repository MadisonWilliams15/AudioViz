 ...
 */
public class PlayerController implements Initializable, Startable {
    ...
    { 
    ChangeListener<Boolean> lambdaChangeListener2 = (ObservableValue<? extends Boolean> observable, Boolean oldValue, final Boolean newValue) -> {
    ...
    timeSlider.valueChangingProperty().addListener(lambdaChangeListener2);
    }
